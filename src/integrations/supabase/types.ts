  ...
  public: {
    Tables: {
      ...
      plan_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "plan_settings_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users_view"
            referencedColumns: ["id"]
      ...
      renewal_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "renewal_history_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users_view"
            referencedColumns: ["id"]
      ...
      reseller_goals: {
        ...
        Relationships: [
          {
            foreignKeyName: "reseller_goals_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "admin_users_view"
            referencedColumns: ["id"]
      ...
      sent_contacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "sent_contacts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "admin_users_view"
            referencedColumns: ["id"]
